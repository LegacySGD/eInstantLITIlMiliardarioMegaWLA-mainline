...
public class LITIlMiliardarioMegaWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITIlMiliardarioMegaWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITIlMiliardarioMegaWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITIlMiliardarioMegaWLAIW/InitOutcome.xml").getDocumentElement();
